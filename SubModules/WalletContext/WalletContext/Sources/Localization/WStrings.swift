...
public enum WStrings: String {
    ...
    case Wallet_Home_TransactionPending = "Wallet.Home.TransactionPending"
    ...
    case Wallet_Send_OwnAddressAlertTitle = "Wallet.Send.OwnAddressAlertTitle"
    case Wallet_Send_OwnAddressAlertText = "Wallet.Send.OwnAddressAlertText"
    case Wallet_Send_OwnAddressAlertProceed = "Wallet.Send.OwnAddressAlertProceed"
    case Wallet_Send_TransactionInProgress = "Wallet.Send.TransactionInProgress"
    case Wallet_Send_SyncInProgress = "Wallet.Send.SyncInProgress"
