...
public class TitleValueRowView: UIView {

    public init(title: String, value: String?, valueIcon: UIImage? = nil, separator: Bool = true) {
        super.init(frame: .zero)
        setupViews(title: title, value: value, valueIcon: valueIcon, separator: separator)
    }
    ...
    private func setupViews(title: String, value: String?, valueIcon: UIImage?, separator: Bool) {
    ...
    public func setValueText(_ text: String?) {
