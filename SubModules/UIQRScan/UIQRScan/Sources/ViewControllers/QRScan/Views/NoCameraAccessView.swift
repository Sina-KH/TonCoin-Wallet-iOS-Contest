...
public class NoCameraAccessView: UIView {
    ...
    private func setupView() {
        ...
        // bottom actions view
        let bottomActionsView = BottomActionsView(primaryAction: BottomAction(title: WStrings.Wallet_QRScan_NoAccessOpenSettings.localized, onPress: {
        ...
        let headerView = HeaderView(title: WStrings.Wallet_QRScan_NoAccessTitle.localized,
                                    description: WStrings.Wallet_QRScan_NoAccessCamera.localized)
