...
//        return [:]
//    }
//    guard let path = Bundle.main.path(forResource: "Localizable", ofType: "strings") else {
//        return [:]
//    }
...
//    guard let filePath = Bundle.main.path(forResource: "WalletStrings", ofType: "mapping") else {
//        fatalError()
//    }
...
//
//    // new version strings
//    public var Wallet_Words_NotDoneSkip: String { return self._s[222]! }
//
